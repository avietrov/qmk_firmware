...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOLS] = LAYOUT(
         KC_ESC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  TO_ADJ,
        XXXXXXX,  KC_GRV, KC_LABK, KC_RABK, KC_MINS, KC_PIPE,                       KC_CIRC,  KC_DLR, KC_LCBR, KC_RCBR, XXXXXXX, KC_BSPC,
        KC_LCTL, KC_EXLM, KC_LBRC, KC_RBRC,  KC_EQL, KC_AMPR,                         KC_AT, KC_SCLN, KC_LPRN, KC_RPRN, KC_QUES, XXXXXXX,
        XXXXXXX, KC_TILD, KC_PLUS, KC_ASTR, KC_UNDS, KC_PERC, XXXXXXX,     XXXXXXX, KC_HASH, KC_COLN, KC_BSLS, XXXXXXX, XXXXXXX, KC_ESC,
                          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX

    ),
    [_NAVIGATION] = LAYOUT(
         TO_ADJ, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  TO_ADJ,
         KC_TAB, XXXXXXX, MS_BTN1,   MS_UP, MS_BTN2, MS_WHLD,                       NV_BACK, NV_PREV, NV_NEXT, NV_FRWD, XXXXXXX,  KC_DEL,
        KC_LCTL, XXXXXXX, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLU,                       KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, XXXXXXX,  TO_NAV,
        KC_LSFT, XXXXXXX, MS_WHLL, XXXXXXX, MS_WHLR, KC_LSFT, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_ESC,
                          KC_LCTL, XXXXXXX, XXXXXXX, KC_LALT, KC_LGUI,     XXXXXXX, XXXXXXX, MS_ACL0, MS_ACL1, MS_ACL2

    ),
    [_ADJUST] = LAYOUT(
        XXXXXXX,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       XXXXXXX, XXXXXXX,  KC_EQL, KC_ASTR, XXXXXXX, XXXXXXX,
