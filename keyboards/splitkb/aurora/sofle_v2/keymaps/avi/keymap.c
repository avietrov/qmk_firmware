...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOLS] = LAYOUT(
        ...
        XXXXXXX,  KC_GRV, KC_LABK, KC_RABK, KC_MINS, KC_PIPE,                       KC_CIRC, KC_LCBR, KC_RCBR,  KC_DLR, XXXXXXX, KC_BSPC,
        KC_LCTL, KC_EXLM, KC_ASTR, KC_UNDS,  KC_EQL, KC_AMPR,                         KC_AT, KC_LPRN, KC_RPRN, KC_SCLN, KC_QUES, XXXXXXX,
        XXXXXXX, KC_TILD, KC_PLUS, KC_LBRC, KC_RBRC, KC_PERC, XXXXXXX,     XXXXXXX, KC_HASH, KC_COLN, KC_BSLS, XXXXXXX, XXXXXXX, KC_ESC,
